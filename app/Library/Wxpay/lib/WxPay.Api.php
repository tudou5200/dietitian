...
class WxPayApi
{
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, app_path('Library/Wxpay/cert/apiclient_cert.pem'));
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, app_path('Library/Wxpay/cert/apiclient_key.pem'));
		}
		//post提交方式
